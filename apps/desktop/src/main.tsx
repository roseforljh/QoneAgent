...
class StartupErrorBoundary extends Component<StartupErrorBoundaryProps, StartupErrorBoundaryState> {
  ...
  render() {
    ...
    return (
      <main style={{ minHeight: "100vh", padding: 32, fontFamily: "system-ui, sans-serif", color: "#171717", background: "#fff" }}>
        <h1 style={{ margin: "0 0 12px", fontSize: 20 }}>Qone 启动失败</h1>
        <p style={{ margin: "0 0 16px", color: "#666" }}>前端渲染时发生异常，请将下面错误信息反馈给开发者。</p>
        <pre style={{ margin: 0, padding: 16, overflow: "auto", whiteSpace: "pre-wrap", border: "1px solid #ddd", borderRadius: 8, background: "#f7f7f7", color: "#9d2626" }}>
...
try {
  ...
  rootElement.style.cssText = "padding:32px;white-space:pre-wrap;font:14px/1.6 system-ui,sans-serif;color:#9d2626;background:#fff";
}
